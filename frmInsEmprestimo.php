...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    <title>Inserção de Emprestimos</title>
<body>
<div class="w3-top">
...
<div class="w3-content" style="max-width:2000px;margin-top:60px;margin-left:-100px">
    ...
    <div class="container col-md-8">
        ...
        <form id="frmNovoEmprestimo" name="frmNovoEmprestimo" method="POST" action="insEmprestimo.php">
            <div class="form-group">
                <label for="lblDvd">DVD: </label>
                <input class="form-control col-md-6" type="text" id="txtDvd"
                       name="txtDvd" placeholder="Informe o Dvd">
            </div>
            <div class="form-group">
                <label for="lblCliente">Cliente: </label>
                <input class="form-control col-md-6" type="text" id="txtCli"
                       name="txtCli" placeholder="Informe o Cliente">
            </div>
            <div class="form-group">
                <label for="lblValor_Emprestimo">Valor do Empréstimo: </label>
                <input class="form-control col-md-6" type="text" id="txtEmprestimo"
                       name="txtEmprestimo" placeholder="Informe o Valor do Empréstimo">
            </div>
            <div class="form-group">
                <label for="lblValor_Pago">Valor Pago: </label>
                <input class="form-control col-md-6" type="text" id="txtPago"
                       name="txtPago" placeholder="Informe o Valor Pago">
            </div>
            <div class="form-group">
                <label for="lblData">Data: </label>
                <input class="form-control col-md-6" type="text" id="txtData"
                       name="txtData" placeholder="Informe a Data">
            </div>
            <div class="form-group">
                <label for="lblDel">Prazo Devolução: </label>
                <input class="form-control col-md-6" type="text" id="txtDevolucao"
                       name="txtDevolucao" placeholder="Informe o Prazo para Devolução">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control col-md-6" type="text" id="txtSit"
                       name="txtSit" placeholder="Informe a Situação">
            </div>
