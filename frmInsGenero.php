...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    <title>Inserção de Gêneros</title>
<body>
<div class="w3-top">
...
<div class="container col-md-8">
    ...
    <form id="frmNovoGenero" name="frmNovoGenero" method="POST" action="insGenero.php">
        <div class="form-group">
            <label for="lblDes">Descrição: </label>
            <input class="form-control col-md-6" type="text" id="txtDes"
                   name="txtDes" placeholder="Informe a Descrição do Gênero">
        </div>
        <input type="submit" id="btEnviar" name="btEnviar"
               class="btn btn-success btn-lg" value="Salvarr">
