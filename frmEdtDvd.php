...
<div class="container col-md-8">
    <h1>Editar DVD's</h1>
    <form id="frmEdtDvd" name="frmEdtDvd" method="POST" action="edtDvd.php">
        ...
        <div class="form-group">
            ...
            <input type="text" id="txtFil" name="txtFil" class="form-control col-md-5" value="<?php echo $edita['filme']?>">
        </div>
